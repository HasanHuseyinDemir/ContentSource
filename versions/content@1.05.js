pages.map(async(item)=>{
    ...
    item.data=data;
    item.render=async()=>{
        var element = document.querySelector(item.component);
...
atoms.map((atom)=>{
createAtom(atom.alias,atom.data()),
atom.render=()=>{
    document.querySelectorAll(atom.alias).forEach(page=>page.innerHTML=atom.data());
}});
