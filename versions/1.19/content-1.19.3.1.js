...
contents.map(async(item)=>{
        switch(item.type){
            ...
            data=(data.replaceAll("$this",item.name));
            data=cNamer(data);
    ...
    content=async(item,key)=>{
        ...
        await contents.push(eval(pageName));
            ...
            if(key){
                ...
                data=(data.replaceAll("$this",pageKey));
            }else{
                data=(data.replaceAll("__",pageName+"_"));
                data=(data.replaceAll("$this",pageName));
            }
    ...
    cRender=async(item,to,key)=>{
        ...
        data=(data.replaceAll("$this",key?key:keys));
    ...
    loadScript=async(file,key)=>{
        ...
        script=(script.replaceAll("$this",key));
        await eval(script);
        set();
    };
